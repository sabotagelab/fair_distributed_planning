...
for trial in range(trials):
    ...
    res = [trial, valid_sol, dist_sol_obj, dist_sol_energy, dist_sol_fairness1, dist_sol_fairness4, dist_sol_obstacle, dist_sol_collision, walltime, cputime, converge_iter]
